...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "ajax": {
            "url": "/Admin/StanyMinimalne/GetAll"
        },
        "columns": [
                ...
                "render": function (data) {
                    return `
                            <div class="text-center">
                                <a href="/Admin/StanyMinimalne/Edit/${data}" class="btn btn-info" style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edytuj">
